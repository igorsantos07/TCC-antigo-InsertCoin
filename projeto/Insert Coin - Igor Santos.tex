...
Atualmente no mercado h\'a diversas empresas focadas em produtos similaeres ao que propomos neste projeto. No entanto, foi identificado que nenhum deles oferece todas as funcionalidades que planejamos implementar, o que significa que, ap\'os o lançamento vamos estar \`a frente da concorr\^encia e aptos a conquistar novos clientes, sejam estes experientes em outros produtos ou interessados em experimentar algo novo. Listamos aqui as principais empresas concorrentes at\'e o momento:

\begin{tabular}{|c|c|c|}
\hline 
\textbf{Granatum} & \textbf{Organizz}e & \textbf{Mint (americano)} \\ 
\hline 
Yupee & MyFreeComm Finance & Manubia \\ 
\hline 
GBolso & Spesa & Money Care \\ 
\hline 
Monefy & \multicolumn{2}{c|}{\emph{Outras dezenas de aplicativos m\'oveis similares...}} \\ 
\hline 
\end{tabular}

Foi notado que algumas empresas possuem sistemas de parceria com algumas instituiç\~oes banc\'arias, o que em tese poderia trazer mais clientes destes bancos aos seus aplicativos. No entanto, n\~ao h\'a not\'icia de divulgaç\~ao destes sistemas dentro das ag\^encias ou em outros ve\'iculos relacionados aos bancos. Isso nos leva a crer que a parceria foi criada para iniciar um processo de integraç\~ao banc\'aria, mas por motivos alheios ao conhecimento p\'ublico, tal integraç\~ao n\~ao evoluiu com outros bancos.\\
A \'unica exceç\~ao a essa regra \'e o \emph{Mint}, mas que n\~ao representa concorr\^encia direta pois nem sequer faz parte do mercado brasileiro. Apesar disso, ele \'e listado aqui para servir de exemplo de como a vida do \'usuario pode ser facilitada; o sistema do \emph{Mint} possui integraç\~ao com uma longa, longa lista de instituiç\~oes financeiras dos Estados Unidos e do Canad\'a. Isso permite que os usu\'arios n\~ao precisem mais criar novas entradas manualmente para se organizarem -- o aplicativo web busca as informaç\~oes diretamente nos sistemas do banco.
